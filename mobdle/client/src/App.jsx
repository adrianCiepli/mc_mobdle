...
function App() {
  ...
  return (
    <div className="App">
      ...
      {gotCorrect && <div className='shareable-guesses'><img src='/share_white.png' className='share-button' alt='Share Button' />
        <div className='shareable-copy-text' onClick={handleCopy}>{copied ? "Copied!" : "Share results"}</div></div>}
